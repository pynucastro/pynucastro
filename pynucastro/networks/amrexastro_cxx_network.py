    ...
    def _write_network(self, odir=None):
        ...
        with open(os.path.join(odir, "pynucastro.net"), "w") as of:
            for nuc in self.unique_nuclei:
                of.write(f"{nuc.spec_name:25} {nuc.short_spec_name.capitalize():6} {nuc.A:6.1f} {nuc.Z:6.1f}\n")

            for nuc in self.approx_nuclei:
                of.write(f"__extra_{nuc.spec_name:17} {nuc.short_spec_name.capitalize():6} {nuc.A:6.1f} {nuc.Z:6.1f}\n")
