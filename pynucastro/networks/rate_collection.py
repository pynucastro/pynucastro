...
# Lodders et al. 2020 present day solar abundances
LOD_SYMBOL = np.array(['h', 'h', 'he', 'he', 'li', 'li', 'be', 'b', 'b', 'c', 'c', 'n',
       'n', 'o', 'o', 'o', 'f', 'ne', 'ne', 'ne', 'na', 'mg', 'mg', 'mg',
       'al', 'si', 'si', 'si', 'p', 's', 's', 's', 's', 'cl', 'cl', 'ar',
       'ar', 'ar', 'k', 'k', 'k', 'ca', 'ca', 'ca', 'ca', 'ca', 'ca',
       'sc', 'ti', 'ti', 'ti', 'ti', 'ti', 'v', 'v', 'cr', 'cr', 'cr',
       'cr', 'mn', 'fe', 'fe', 'fe', 'fe', 'co', 'ni', 'ni', 'ni', 'ni',
       'ni', 'cu', 'cu', 'zn', 'zn', 'zn', 'zn', 'zn', 'ga', 'ga', 'ge',
       'ge', 'ge', 'ge', 'ge', 'as', 'se', 'se', 'se', 'se', 'se', 'se',
       'br', 'br', 'kr', 'kr', 'kr', 'kr', 'kr', 'kr', 'rb', 'rb', 'sr',
       'sr', 'sr', 'sr', 'y', 'zr', 'zr', 'zr', 'zr', 'zr', 'nb', 'mo',
       'mo', 'mo', 'mo', 'mo', 'mo', 'mo', 'ru', 'ru', 'ru', 'ru', 'ru',
       'ru', 'ru', 'rh', 'pd', 'pd', 'pd', 'pd', 'pd', 'pd', 'ag', 'ag',
       'cd', 'cd', 'cd', 'cd', 'cd', 'cd', 'cd', 'cd', 'in', 'in', 'sn',
       'sn', 'sn', 'sn', 'sn', 'sn', 'sn', 'sn', 'sn', 'sn', 'sb', 'sb',
       'te', 'te', 'te', 'te', 'te', 'te', 'te', 'te', 'i', 'xe', 'xe',
       'xe', 'xe', 'xe', 'xe', 'xe', 'xe', 'xe', 'cs', 'ba', 'ba', 'ba',
       'ba', 'ba', 'ba', 'ba', 'la', 'la', 'ce', 'ce', 'ce', 'ce', 'pr',
       'nd', 'nd', 'nd', 'nd', 'nd', 'nd', 'nd', 'sm', 'sm', 'sm', 'sm',
       'sm', 'sm', 'sm', 'eu', 'eu', 'gd', 'gd', 'gd', 'gd', 'gd', 'gd',
       'gd', 'tb', 'dy', 'dy', 'dy', 'dy', 'dy', 'dy', 'dy', 'ho', 'er',
       'er', 'er', 'er', 'er', 'er', 'tm', 'yb', 'yb', 'yb', 'yb', 'yb',
       'yb', 'yb', 'lu', 'lu', 'hf', 'hf', 'hf', 'hf', 'hf', 'hf', 'ta',
       'ta', 'w', 'w', 'w', 'w', 'w', 're', 're', 'os', 'os', 'os', 'os',
...
LOD_Z = np.array([1,  1,  2,  2,  3,  3,  4,  5,  5,  6,  6,  7,  7,  8,  8,  8,  9,
       ...
       28, 28, 29, 29, 30, 30, 30, 30, 30, 31, 31, 32, 32, 32, 32, 32, 33,
       34, 34, 34, 34, 34, 34, 35, 35, 36, 36, 36, 36, 36, 36, 37, 37, 38,
       38, 38, 38, 39, 40, 40, 40, 40, 40, 41, 42, 42, 42, 42, 42, 42, 42,
       44, 44, 44, 44, 44, 44, 44, 45, 46, 46, 46, 46, 46, 46, 47, 47, 48,
       48, 48, 48, 48, 48, 48, 48, 49, 49, 50, 50, 50, 50, 50, 50, 50, 50,
       50, 50, 51, 51, 52, 52, 52, 52, 52, 52, 52, 52, 53, 54, 54, 54, 54,
       54, 54, 54, 54, 54, 55, 56, 56, 56, 56, 56, 56, 56, 57, 57, 58, 58,
       58, 58, 59, 60, 60, 60, 60, 60, 60, 60, 62, 62, 62, 62, 62, 62, 62,
       63, 63, 64, 64, 64, 64, 64, 64, 64, 65, 66, 66, 66, 66, 66, 66, 66,
       67, 68, 68, 68, 68, 68, 68, 69, 70, 70, 70, 70, 70, 70, 70, 71, 71,
...
LOD_A = np.array([1,   2,   3,   4,   6,   7,   9,  10,  11,  12,  13,  14,  15,
       ...
       201, 202, 204, 203, 205, 204, 206, 207, 208, 209, 232, 234, 235,
       238])
LOD_X = np.array([7.462e-01, 0.000e+00, 7.677e-05, 2.388e-01, 6.197e-10, 8.842e-09,
       1.375e-10, 8.637e-10, 3.798e-09, 2.596e-03, 2.941e-05, 7.314e-04,
       1.775e-06, 6.362e-03, 2.362e-06, 1.350e-05, 5.767e-07, 1.950e-03,
       4.909e-06, 1.528e-04, 3.184e-05, 4.655e-04, 6.166e-05, 7.035e-05,
       5.288e-05, 6.180e-04, 3.249e-05, 2.219e-05, 6.130e-06, 3.184e-04,
       2.583e-06, 1.489e-05, 5.515e-08, 3.360e-06, 1.134e-06, 7.124e-05,
       1.367e-05, 2.295e-08, 3.140e-06, 4.022e-10, 2.382e-07, 5.313e-05,
       3.720e-07, 7.926e-08, 1.257e-06, 2.202e-09, 1.229e-07, 3.630e-08,
       2.235e-07, 2.059e-07, 2.079e-06, 1.560e-07, 1.532e-07, 8.377e-10,
       3.351e-07, 6.833e-07, 1.369e-05, 1.586e-06, 4.006e-07, 1.197e-05,
       6.591e-05, 1.074e-03, 2.524e-05, 3.415e-06, 3.191e-06, 4.595e-05,
       1.838e-05, 8.103e-07, 2.626e-06, 6.893e-07, 5.579e-07, 2.567e-07,
       9.497e-07, 5.513e-07, 8.178e-08, 3.792e-07, 1.340e-08, 3.584e-08,
       2.447e-08, 4.138e-08, 5.687e-08, 1.625e-08, 7.775e-08, 1.692e-08,
       1.090e-08, 1.027e-09, 1.133e-08, 9.455e-09, 2.987e-08, 6.445e-08,
       1.170e-08, 1.184e-08, 1.181e-08, 3.547e-10, 2.298e-09, 1.176e-08,
       1.180e-08, 5.867e-08, 1.809e-08, 1.034e-08, 4.081e-09, 2.614e-10,
       4.734e-09, 3.353e-09, 4.052e-08, 9.266e-09, 1.211e-08, 2.670e-09,
       4.124e-09, 4.273e-09, 7.032e-10, 1.736e-09, 8.368e-10, 5.355e-10,
       9.369e-10, 9.950e-10, 5.781e-10, 1.478e-09, 6.056e-10, 2.298e-10,
       7.976e-11, 5.451e-10, 5.458e-10, 7.447e-10, 1.392e-09, 8.365e-10,
       8.334e-10, 3.443e-11, 3.824e-10, 7.739e-10, 9.566e-10, 9.437e-10,
       4.266e-10, 6.609e-10, 6.236e-10, 5.075e-11, 3.620e-11, 5.188e-10,
       5.368e-10, 1.022e-09, 5.221e-10, 1.239e-09, 3.305e-10, 2.164e-11,
       4.708e-10, 9.384e-11, 6.550e-11, 3.304e-11, 1.450e-09, 7.731e-10,
       2.458e-09, 8.775e-10, 3.364e-09, 4.849e-10, 6.175e-10, 5.939e-10,
       4.535e-10, 1.436e-11, 3.593e-10, 1.266e-10, 6.739e-10, 1.009e-09,
       2.697e-09, 4.579e-09, 4.961e-09, 4.835e-09, 2.078e-11, 1.810e-11,
       3.739e-10, 4.654e-09, 7.439e-10, 3.751e-09, 4.579e-09, 1.716e-09,
       1.417e-09, 1.172e-09, 1.556e-11, 1.580e-11, 3.529e-10, 9.697e-10,
       1.162e-09, 1.676e-09, 1.078e-08, 1.322e-12, 1.528e-09, 6.513e-12,
       9.913e-12, 3.453e-09, 4.386e-10, 5.908e-10, 7.956e-10, 3.595e-09,
       7.069e-10, 2.639e-10, 5.174e-10, 1.737e-10, 1.724e-10, 2.896e-11,
       1.433e-10, 1.081e-10, 1.338e-10, 7.184e-11, 2.643e-10, 2.275e-10,
       1.732e-10, 1.916e-10, 4.619e-13, 2.783e-11, 1.901e-10, 2.645e-10,
       2.036e-10, 3.251e-10, 2.899e-10, 2.380e-10, 1.868e-13, 1.514e-12,
       3.640e-11, 2.965e-10, 4.027e-10, 3.958e-10, 4.521e-10, 3.521e-10,
       1.383e-12, 1.613e-11, 3.416e-10, 2.346e-10, 2.784e-10, 1.557e-10,
       1.631e-10, 1.207e-12, 3.054e-11, 1.458e-10, 2.253e-10, 1.682e-10,
       3.367e-10, 1.383e-10, 1.551e-10, 4.216e-12, 1.042e-12, 3.457e-11,
       1.225e-10, 1.808e-10, 9.090e-11, 2.350e-10, 1.121e-14, 9.321e-11,
       8.623e-13, 1.661e-10, 9.030e-11, 1.939e-10, 1.818e-10, 8.641e-11,
       1.460e-10, 5.730e-13, 4.638e-11, 4.927e-11, 3.912e-09, 4.797e-10,
       7.843e-10, 1.232e-09, 1.080e-09, 1.835e-09, 7.282e-13, 4.507e-11,
       1.891e-09, 1.958e-09, 1.473e-09, 4.297e-10, 9.203e-10, 4.695e-12,
...
class Lodders(Composition):
    ...
    def __init__(self, z=None, half_life_thresh=None):
        nuclei = []
        for symbol, A in zip(LOD_SYMBOL, LOD_A):
            if symbol == "h" and A == 1:
                name = "p"
            else:
                name = f"{symbol}{A}"
    ...
    def get_from_lodders(self, z=None, half_life_thresh=None):
        ...
        for Z_i, X_i in zip(LOD_Z, LOD_X):
            if Z_i == 1:
                x_solar += X_i
            elif Z_i == 2:
                y_solar += X_i
        ...
        for symbol, Z_i, A_i, X_i in zip(LOD_SYMBOL, LOD_Z, LOD_A, LOD_X):
            if symbol == "h" and A_i == 1:
                name = "p"
            else:
                name = f"{symbol}{A_i}"
