# test the comparison of the BetaLimitedRate on a beta-limited
# CNO cycle
...
class TestNetworkCompare:
    ...
    def lib(cls, reaclib_library):
        ...
        rn14pg_betalim = BetaLimitedRate(rn14pg,
                                         [ro15betap, ro14betap],
                                         limiter_nucleus="p",
        ...
        rf17betap = reaclib_library.get_rate_by_name("f17(,)o17")
    ...
    @classmethod
    def nc(cls, lib):
        cxx_test_path = Path("_test_compare_beta_limited_cxx/")
        amrex_test_path = Path("_test_compare_beta_limited_amrex/")
    ...
    def eval_cond1(cls, nc):
        # thermodynamic conditions -- this should be beta-limited
        rho = 200
        T = 2.e8
