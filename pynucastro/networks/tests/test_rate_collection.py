...
class TestRateCollection:
    ...
    def test_get_ratesg(self, rc):
        ...
        assert len(rr) == 4
        assert rr[0].fname == "O16_to_He4_C12"
        assert rr[1].fname == "C12_to_He4_He4_He4"
        assert rr[2].fname == "He4_C12_to_O16"
        assert rr[3].fname == "He4_He4_He4_to_C12"

    def test_get_rate(self, rc):
        r = rc.get_rate("He4_He4_He4_to_C12")
        assert r.fname == "He4_He4_He4_to_C12"

    def test_find_reverse(self, rc):
        rr = rc.find_reverse(rc.get_rate("He4_C12_to_O16"))
        assert rr.fname == "O16_to_He4_C12"
