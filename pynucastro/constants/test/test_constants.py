...
class TestConstants:
    def test_constants(self):
        ...
        assert constants.m_u_MeV == approx(constants.m_u * constants.c_light**2 * constants.erg2MeV)
        assert constants.m_p == approx(1.67262192e-24)
        assert constants.m_p_MeV == approx(constants.m_p * constants.c_light**2 * constants.erg2MeV)
        assert constants.m_n == approx(1.674927498e-24)
        assert constants.m_n_MeV == approx(constants.m_n * constants.c_light**2 * constants.erg2MeV)
        assert constants.m_e == approx(9.1093837e-28)
