...
ANSWER_ETFSIQ_LOW = log(array([1.000271, 1.002656, 1.009124, 1.035543, 1.076750, 1.128518, 1.187847, 1.252797,
...
ANSWER_FRDM_LOW = log(array([1.000157, 1.001534, 1.005265, 1.020486, 1.044185, 1.073899, 1.107886, 1.145013,
...
ANSWER_ETFSIQ_HIGH = log(array([5.79E+000, 1.07E+001, 2.13E+001, 4.38E+001, 9.23E+001, 1.97E+002, 4.23E+002,
...
ANSWER_FRDM_HIGH = log(array([9.40e+007, 2.81e+009, 4.93e010, 1.95e+012, 8.84e+013, 3.66e+015, 1.44e+017,
...
TEMPERATURES_HIGH = array([12.0E+9, 14.0E+9, 16.0E+9, 18.0E+9, 20.0E+9, 22.0E+9, 24.0E+9,
                           ...
                           210.0E+9, 220.0E+9, 230.0E+9, 240.0E+9, 250.0E+9, 275.0E+9]) * 1.e-9
...
class TestPartition:
    ...
    def test_pf_table(self):
        ...
        assert all(co46_pf_etfsiq_low.log_pf_data == ANSWER_ETFSIQ_LOW)
        assert all(co46_pf_etfsiq_low.T9_points == TEMPERATURES_LOW)

        assert all(ne37_pf_frdm_low.log_pf_data == ANSWER_FRDM_LOW)
        assert all(ne37_pf_frdm_low.T9_points == TEMPERATURES_LOW)

        assert all(fe47_pf_etfsiq_high.log_pf_data == ANSWER_ETFSIQ_HIGH)
        assert all(fe47_pf_etfsiq_high.T9_points == TEMPERATURES_HIGH)

        assert all(po188_pf_frdm_high.log_pf_data == ANSWER_FRDM_HIGH)
        assert all(po188_pf_frdm_high.T9_points == TEMPERATURES_HIGH)
