...
contains
  ...
  subroutine FCVFUN(T, Y, YDOT, IPAR, RPAR, IER) bind(C, name='fcvfun_')
    ...
    YDOT(jp) = ( &
       + 0.500000000000000 * dens * Y(jc12)**2 * reactvec(i_scor, k_c12_c12p_na23) * reactvec(i_rate, k_c12_c12p_na23) &
       + Y(jn) * reactvec(i_scor, k_n_p) * reactvec(i_rate, k_n_p) &
       )

    YDOT(jhe4) = ( &
       + 0.500000000000000 * dens * Y(jc12)**2 * reactvec(i_scor, k_c12_c12a_ne20) * reactvec(i_rate, k_c12_c12a_ne20) &
       )

    YDOT(jc12) = ( &
       - 2 * 0.500000000000000 * dens * Y(jc12)**2 * reactvec(i_scor, k_c12_c12a_ne20) * reactvec(i_rate, k_c12_c12a_ne20) &
       - 2 * 0.500000000000000 * dens * Y(jc12)**2 * reactvec(i_scor, k_c12_c12n_mg23) * reactvec(i_rate, k_c12_c12n_mg23) &
       - 2 * 0.500000000000000 * dens * Y(jc12)**2 * reactvec(i_scor, k_c12_c12p_na23) * reactvec(i_rate, k_c12_c12p_na23) &
       )
    ...
    YDOT(jne23) = ( &
       - Y(jne23) * reactvec(i_scor, k_ne23_na23) * reactvec(i_rate, k_ne23_na23) &
       + Y(jna23) * reactvec(i_scor, k_na23_ne23) * reactvec(i_rate, k_na23_ne23) &
       )
  ...
  subroutine FCVDJAC(NEQ, T, Y, FY, DJAC, H_STEP, IPAR, RPAR, WK1, WK2, WK3, IER) bind(C, name='fcvdjac_')
    ...
    if (T == 0.0d0) then
      ...
      DJAC(jn,jn) = ( &
         -    reactvec(i_scor, k_n_p) * reactvec(i_rate, k_n_p) &
         )
      ...
      DJAC(jn,jc12) = ( &
         + 0.500000000000000 * dens * 2*Y(jc12) * reactvec(i_scor, k_c12_c12n_mg23) * reactvec(i_rate, k_c12_c12n_mg23) &
         )
      ...
      DJAC(jp,jc12) = ( &
         + 0.500000000000000 * dens * 2*Y(jc12) * reactvec(i_scor, k_c12_c12p_na23) * reactvec(i_rate, k_c12_c12p_na23) &
         )
      ...
      DJAC(jhe4,jc12) = ( &
         + 0.500000000000000 * dens * 2*Y(jc12) * reactvec(i_scor, k_c12_c12a_ne20) * reactvec(i_rate, k_c12_c12a_ne20) &
         )
      ...
      DJAC(jc12,jc12) = ( &
         - 2 * 0.500000000000000 * dens * 2*Y(jc12) * reactvec(i_scor, k_c12_c12a_ne20) * reactvec(i_rate, k_c12_c12a_ne20) &
         - 2 * 0.500000000000000 * dens * 2*Y(jc12) * reactvec(i_scor, k_c12_c12n_mg23) * reactvec(i_rate, k_c12_c12n_mg23) &
         - 2 * 0.500000000000000 * dens * 2*Y(jc12) * reactvec(i_scor, k_c12_c12p_na23) * reactvec(i_rate, k_c12_c12p_na23) &
         )
      ...
      DJAC(jne23,jne23) = ( &
         -    reactvec(i_scor, k_ne23_na23) * reactvec(i_rate, k_ne23_na23) &
         )

      DJAC(jne23,jna23) = ( &
         +    reactvec(i_scor, k_na23_ne23) * reactvec(i_rate, k_na23_ne23) &
         )
