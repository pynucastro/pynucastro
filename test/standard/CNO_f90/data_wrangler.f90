module data_wrangler
  use cvode_parameters, only: cv_data
...
contains
  ...
  subroutine write_solution(net_history, KFIN)
    ...
    write(2, fmt=hfmt) 'Y_p', 'Y_he4', 'Y_c12', 'Y_c13', 'Y_n13', 'Y_n14', 'Y_n15', 'Y_o14', 'Y_o15', 'E_nuc', 'Time'
    do K = 1, KFIN
