program integrator
  ...
  cv_data%Y0(jc13)   = net_initial_abundances%yc13
  cv_data%Y0(jn13)   = net_initial_abundances%yn13
  cv_data%Y0(jn14)   = net_initial_abundances%yn14
  cv_data%Y0(jn15)   = net_initial_abundances%yn15
  cv_data%Y0(jo14)   = net_initial_abundances%yo14
  cv_data%Y0(jo15)   = net_initial_abundances%yo15
  ...
  write(*,'(A,ES25.14)') 'c13: ', cv_data%Y(jc13)*aion(jc13)
  write(*,'(A,ES25.14)') 'n13: ', cv_data%Y(jn13)*aion(jn13)
  write(*,'(A,ES25.14)') 'n14: ', cv_data%Y(jn14)*aion(jn14)
  write(*,'(A,ES25.14)') 'n15: ', cv_data%Y(jn15)*aion(jn15)
  write(*,'(A,ES25.14)') 'o14: ', cv_data%Y(jo14)*aion(jo14)
  write(*,'(A,ES25.14)') 'o15: ', cv_data%Y(jo15)*aion(jo15)
